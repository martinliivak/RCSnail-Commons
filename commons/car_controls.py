...
class CarControls:
    __slots__ = ['gear', 'steering', 'throttle', 'braking', 'update_mode']

    def __init__(self, gear, steering, throttle, braking, update_mode):
        self.gear = gear
...
class CarControlUpdates:
    __slots__ = ['d_gear', 'd_steering', 'd_throttle', 'd_braking', 'update_mode']
